                ...
                <div className="max-w-7xl mx-auto flex justify-start items-center">
                    <div className="flex flex-col w-full gap-40">
                        <div className="flex justify-between">
                            <Image className='w-1/2 max-h-80 object-cover rounded-lg grayscale-[0.4]' width={500} height={500} src="https://images.unsplash.com/photo-1523975864490-174dd4d9a41e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Image of brand journey" />
                            <div className="flex flex-col w-[45%] gap-10">
                                <h2 className="text-4xl text-red-400 font-bold">Our Journey to Fashion Excellence</h2>
                                <p className="font-medium text-lg text-slate-700">ECOM is a passion-driven fashion brand founded in 2023. What started as a small boutique has now grown into a renowned online destination for trendy and high-quality clothing, accessories, shoes, and pants. Over the years, we have established ourselves as a trusted name in the industry, constantly evolving to meet the ever-changing fashion needs of our valued customers.</p>
                            </div>
                        </div>
                        <div className="flex justify-between">
                            <div className="flex flex-col w-[45%] gap-10">
                                <h2 className="text-4xl text-red-400 font-bold">Meet Our Fashion Enthusiasts</h2>
                                <p className="font-medium text-lg text-slate-700">Behind ECOM, there is a dedicated team of fashion enthusiasts who are constantly curating the latest trends and timeless styles to bring you the best fashion experience. Our team of designers, stylists, and fashion experts strive to deliver superior quality, impeccable craftsmanship, and exceptional attention to detail. With their expertise and passion, they ensure that every piece you find at our store reflects our commitment to style and comfort.</p>
                            </div>
                            <Image className='w-1/2 max-h-80 object-cover rounded-lg grayscale-[0.4]' width={500} height={500} src="https://images.unsplash.com/photo-1538688423619-a81d3f23454b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="A team of people" />
                        </div>
                        <div className="flex justify-between">
                            <Image className='w-1/2 max-h-80 object-cover rounded-lg grayscale-[0.4]' width={500} height={500} src="https://images.unsplash.com/flagged/photo-1553642618-de0381320ff3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80" alt="Man in suit" />
                            <div className="flex flex-col w-[45%] gap-10">
                                <h2 className="text-4xl text-red-400 font-bold">Elevate Your Wardrobe with Style</h2>
                                <p className="font-medium text-lg text-slate-700">At ECOM, we offer a diverse range of clothing, accessories, shoes, and pants that cater to all your fashion desires. From elegant dresses and stylish tops to comfortable jeans and statement shoes, our collection is carefully curated to help you express your unique personality and stay on-trend. We source our products from trusted suppliers, ensuring that each item meets our strict quality standards. With a seamless online shopping experience and excellent customer service, we are dedicated to making your fashion journey enjoyable and satisfying.</p>
                            </div>
                        </div>
